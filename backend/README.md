...
## Project Structure
    ...
    ├── testapiautostorybo_124915  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_124915`
...
2. Clone this repo and `cd testapiautostorybo_124915`
